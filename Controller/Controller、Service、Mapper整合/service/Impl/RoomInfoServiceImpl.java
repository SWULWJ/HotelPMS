...
public class RoomInfoServiceImpl implements RoomInfoService {
    ...
    @Override
    public boolean addRoomInfo(int id, int room_num,int type, String state, String building, String floor){
        RoomType roomType = roomTypeMapper.queryById(type);
        RoomInfo roomInfo = new RoomInfo(id,room_num,roomType,state,building,floor);
    ...
    @Override
    public boolean updateRoomInfo(int id, int room_num,int type, String state, String building, String floor) {
        RoomType roomType = roomTypeMapper.queryById(type);
        RoomInfo roomInfo = new RoomInfo(id,room_num,roomType,state,building,floor);
