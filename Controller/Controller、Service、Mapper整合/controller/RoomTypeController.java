...
//    }
    ...
    //添加一条房间类型
    //输入: id,name,price,bedNumber,maxPeople,minTime
...
//    }
    ...
    @RequestMapping(value = "/queryRoomTypeById",method = RequestMethod.GET)
    @ResponseBody
    public List<RoomType> queryRoomTypeById(
            @RequestParam("id") String id
    ){
        List<RoomType> list = new ArrayList<>();
        list.add(roomTypeService.queryRoomTypeById(Integer.parseInt(id)));
        return list;
    }
...
//    }
    ...
    //输入: name
    //输出: List<RoomType>
    @RequestMapping(value = "/queryRoomTypeByName",method = RequestMethod.GET)
    @ResponseBody
    public RoomType queryRoomTypeByName(
            @RequestParam("name") String name
    ){
        return roomTypeService.queryRoomTypeByName(name);
    }
